 ...
 */
class Version20170409165302 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE post');
        $this->addSql('CREATE TABLE post (id INTEGER NOT NULL, author_id INTEGER NOT NULL, title VARCHAR(150) NOT NULL, body CLOB NOT NULL, createdAt DATETIME NOT NULL, slug VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
